...
public class Sql {
    ...
    public int userChecker(String uid, String pwd) {
        ...
        try {
            ...
            while (rs.next()) {
                if (rs.getString("uid").equals(uid) && rs.getString("upwd").equals(pwd) &&
                        rs.getString("utype").equals("0")) {
                    val = 0;
                } else if (rs.getString("uid").equals(uid) && rs.getString("upwd").equals(pwd) &&
                        rs.getString("utype").equals("1")) {
                    val = 2;
                }
            }
            rs.close();
